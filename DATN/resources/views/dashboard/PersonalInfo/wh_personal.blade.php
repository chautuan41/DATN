...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-9">
            ...
            @endforeach
            @endif
            <form method="POST" acction="{{route('admin.handlePersonalInfoWH',['id_staff' => $id_staff])}}"
            ...
            <br><div class="tile-footer">
                <a href="{{route('admin.formChangePWWH',$id_staff)}}" role="button" class="btn btn-primary">Change
                    Password</a>
            </div>
        </div>
    </div>
