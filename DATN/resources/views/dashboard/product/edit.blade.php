                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form action="{{route('products.edit.post',['ID'=>$dt->id]) }}" method="post">
                                    @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="sku" value="{{$dt->sku}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-currency" name="price" value="{{$dt->price}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-currency" name="amount" value="{{$dt->amount}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-currency" name="like" value="{{$dt->like}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
